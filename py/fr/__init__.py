...
breed_rule_list = {
    ...
    ('Plentiful', 'Rare'): (0.99, 0.01),
    ('Common', 'Common'): (0.5, 0.5),
    ('Common', 'Uncommon'): (0.75, 0.25),
    ('Common', 'Limited'): (0.89, 0.11),
    ('Common', 'Rare'): (0.99, 0.01),
    ('Uncommon', 'Uncommon'): (0.5, 0.5),
    ('Uncommon', 'Limited'): (0.86, 0.14),
    ('Uncommon', 'Rare'): (0.98, 0.02),
    ('Limited', 'Limited'): (0.5, 0.5),
    ('Limited', 'Rare'): (0.97, 0.03),
    ('Rare', 'Rare'): (0.5, 0.5),
}
gene_rule_list = {
    ('Plentiful', 'Plentiful'): (0.5, 0.5),
    ...
    ('Common', 'Common'): (0.5, 0.5),
    ('Common', 'Uncommon'): (0.75, 0.25),
    ('Common', 'Limited'): (0.92, 0.08),
    ('Common', 'Rare'): (0.99, 0.01),
    ('Uncommon', 'Uncommon'): (0.5, 0.5),
    ('Uncommon', 'Limited'): (0.85, 0.15),
    ('Uncommon', 'Rare'): (0.98, 0.02),
    ('Limited', 'Limited'): (0.5, 0.5),
    ('Limited', 'Rare'): (0.97, 0.03),
    ('Rare', 'Rare'): (0.5, 0.5),
